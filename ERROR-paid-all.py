...
def clear():
    ...
    print(logo)
#===================[LOGO]===========================
os.system('xdg-open  https://www.facebook.com/titer665555111R ')
os.system('xdg-open  https://chat.whatsapp.com/HHHZPtQlHXMF9BEu6BqAQH?mode=ems_copy_t')
logo=(f"""
...
def ___ERROR___():
    ...
    if __ERROR__ in['A','a','01','1']:os.system(" xdg-open  https://www.facebook.com/titer665555111");___FILE___()
    elif __ERROR__ in ['B','b','02','2']:___RANDOM___()
    elif __ERROR__ in ['C','c','03','3']:os.system('xdg-open  https://www.facebook.com/titer665555111 ');___ERROR___()
    else:
